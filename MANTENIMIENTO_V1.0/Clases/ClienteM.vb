...
Public Class Cliente
    ...
    Public Property EnviarInfo1 As String
        Get
            Return EnviarInfo
        End Get
        Set(value As String)
